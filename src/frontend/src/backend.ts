...
import type { Order as _Order, OrderStatus as _OrderStatus, Product as _Product, ProductCategory as _ProductCategory, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async filterByCategory(arg0: ProductCategory): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByCategory(to_candid_ProductCategory_n3(this._uploadFile, this._downloadFile, arg0));
    ...
    async filterByGemstone(arg0: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByGemstone(arg0);
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByMetalType(arg0: string): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterByMetalType(arg0);
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterByPriceRange(arg0: bigint, arg1: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
    ...
    async getCart(): Promise<Array<bigint>> {
        if (this.processError) {
            try {
    ...
    async sortByPopularity(): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.sortByPopularity();
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitCustomRequest(arg0: CustomJewelleryRequest): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCustomRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        craftsmanshipNotes: value.craftsmanshipNotes,
        description: value.description,
        metalType: value.metalType,
        hallmarkCertified: value.hallmarkCertified,
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "bangles" in value ? ProductCategory.bangles : "bridalSets" in value ? ProductCategory.bridalSets : "traditional" in value ? ProductCategory.traditional : "necklaces" in value ? ProductCategory.necklaces : "earrings" in value ? ProductCategory.earrings : "rings" in value ? ProductCategory.rings : value;
}
...
function to_candid_variant_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductCategory): {
    ...
    return value == ProductCategory.bangles ? {
        bangles: null
    } : value == ProductCategory.bridalSets ? {
        bridalSets: null
    } : value == ProductCategory.traditional ? {
        traditional: null
    } : value == ProductCategory.necklaces ? {
        necklaces: null
    } : value == ProductCategory.earrings ? {
        earrings: null
    } : value == ProductCategory.rings ? {
        rings: null
    } : value;
}
